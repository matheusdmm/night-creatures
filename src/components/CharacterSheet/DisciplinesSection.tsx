...
function PowerRow({
  ...
  return (
    <div className="flex items-center gap-2 py-1 group">
      ...
      <input
        className="flex-1 text-sm text-parchment bg-transparent border-b border-night-border/40
      ...
      <div className="flex items-center gap-3 mb-2">
        <div className="flex-1">
          <div className="flex items-center gap-2">
            {isClanDisc && (
              <span className="text-[10px] text-blood border border-blood/40 rounded px-1 py-0.5 font-cinzel uppercase tracking-wider">
                Clan
              </span>
            )}
            <select
              className="bg-transparent text-parchment font-cinzel text-sm tracking-wide
